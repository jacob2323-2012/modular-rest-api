...
keystone.set('baseLocalisations', {
    ...
    errorMessages: {
        ...
        not_allowed_to_delete_all_records_at_once: "Es ist nicht erlaubt alle Datensätze auf ein Mal zu löschen. Es muss eine ID des zu löschenden Datensatzes angegeben werden."
    }
});
