...
password.prototype.validateInput = function (data, callback) {
	...
	// start addition by jacob2323-2012
	// Consider empty string as "not provided" as well
	if (typeof data[this.path] === 'string' && !data[this.path].length) {
		passwordValue = null;
		confirmValue = null;
	}
	// end addition by jacob2323-2012
...
var validate = password.validate = function (pass, confirm, min, max, complexity, rejectCommon) {
	...
	// start modification by jacob2323-2012
	// old code was with "< min" which does not fit to "longer than"
	...
	// end modification by jacob2323-2012
