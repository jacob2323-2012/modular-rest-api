...
SET MY_LOGDIR=%~dp0%BASE_LOG_DIR_NAME%all_tests\soapui\
mkdir %MY_LOGDIR%
...
call junit-viewer --results=%BASE_LOG_DIR_NAME% --save=%BASE_LOG_DIR_NAME%all_tests\soapui\results.html --minify=false  --contracted
